...
@data_loader
def load_data_mssql(*args, **kwargs):
    """
    Template code for loading data from a Microsoft SQL Server database.

    Args:
    - kwargs should include 'username', 'password', 'host', 'port', 'database', and 'table'.

    Returns:
        pandas.DataFrame - Data loaded from the specified Microsoft SQL Server table.
    """
