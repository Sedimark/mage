...
class CustomSource(BasePythonSource):
    def init_client(self):
        ...
        config_file = get_repo_path() + "/configs/fleviden_test_02/config.yaml"
        self.accuracies = []
        self.active_peers = []
        self.done = False
    ...
    def save_model_locally(self, model_uri: str):
        ...
        model_path = get_repo_path() + "/configs/fleviden_test_02/model_files/" + file_name
    ...
    def load_ngsi_ld(self, entity_id: str):
        ...
        train_path = get_repo_path() + "/configs/fleviden_test_02/train.csv"
        test_path = get_repo_path() + "/configs/fleviden_test_02/test.csv"
        train.to_csv(get_repo_path() + "/configs/fleviden_test_02/train.csv", index=False)
        test.to_csv(get_repo_path() + "/configs/fleviden_test_02/test.csv", index=False)
