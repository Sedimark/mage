...
def get_raw_invoice_data(*args, **kwargs):
    ...
    """
    url_invoice_data = 'https://raw.githubusercontent.com/Sedimark/wings_customer_churn_prediction_model/main/data/raw/invoice_data.xlsx'
    ...
    response = requests.get(url_invoice_data, headers=headers)
    response.raise_for_status()

    # Read Excel file directly from the response content
    from io import BytesIO
    invoice_df = pd.read_excel(BytesIO(response.content))
