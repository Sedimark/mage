...
class CustomSource(BasePythonSource):
    def init_client(self):
        ...
        config_file = get_repo_path() + "/configs/fdsfdsfdsfdfdsfds/config.yaml"
        self.accuracies = []
        self.active_peers = []
        self.done = False
    ...
    def save_model_locally(self, model_uri: str):
        ...
        model_path = get_repo_path() + "/configs/fdsfdsfdsfdfdsfds/model_files/" + file_name
    ...
    def load_ngsi_ld(self, entity_id: str):
        ...
        train_path = get_repo_path() + "/configs/fdsfdsfdsfdfdsfds/train.csv"
        test_path = get_repo_path() + "/configs/fdsfdsfdsfdfdsfds/test.csv"
        train.to_csv(get_repo_path() + "/configs/fdsfdsfdsfdfdsfds/train.csv", index=False)
        test.to_csv(get_repo_path() + "/configs/fdsfdsfdsfdfdsfds/test.csv", index=False)
